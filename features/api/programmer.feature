Feature: Programmer
  ...
  Scenario: POST a programmer
    ...
    And the "Location" header should be "/api/programmers/ObjectOrienter546"
    And the "nickname" property should equal "ObjectOrienter546"
